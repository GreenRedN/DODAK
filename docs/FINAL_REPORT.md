...
| 이름 | 구분 | 주요 역할 |
|------|------|----------|
| 최대영 | 총괄 기획 | 프로젝트 목표 설정 및 범위 확정, 개발 일정 수립 및 진척도 관리, 팀원 간 커뮤니케이션 조율 |
| 주현준 | 프론트엔드 | UI/UX 디자인 및 가이드라인 구축, 홈페이지 구현 |
| 서유나 | 프론트엔드 | UI/UX 디자인 및 가이드라인 구축, 홈페이지 구현 |
| 조민솔 | 프론트엔드 | UI/UX 디자인 및 가이드라인 구축, 홈페이지 구현 |
| 박제연 | 백엔드 | 웹 API 설계 및 시스템 구축, 프론트엔드와 DB 연동 |
| 지태민 | DB | 데이터베이스 구조 설계(스키마 정의) |
